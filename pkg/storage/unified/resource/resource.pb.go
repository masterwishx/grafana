...
// For k8s CREATE+UPDATE requests that contain changes to the secure section
type WriteSecureFieldsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Key *ResourceKey `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// Write the set of fields for a resource
	// NOTE, you can keep any existing fields by sending in the existing GUID
	// Raw values on fields that replace an existing field will get a new GUID in the response
	Fields map[string]*SecureValue `protobuf:"bytes,2,rep,name=fields,proto3" json:"fields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *WriteSecureFieldsRequest) Reset() {
	*x = WriteSecureFieldsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *WriteSecureFieldsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WriteSecureFieldsRequest) ProtoMessage() {}

func (x *WriteSecureFieldsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WriteSecureFieldsRequest.ProtoReflect.Descriptor instead.
func (*WriteSecureFieldsRequest) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{21}
}

func (x *WriteSecureFieldsRequest) GetKey() *ResourceKey {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *WriteSecureFieldsRequest) GetFields() map[string]*SecureValue {
	if x != nil {
		return x.Fields
	}
	return nil
...
// Fetch the secure field properties
type ReadSecureFieldsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// The resource identifier
	Key *ResourceKey `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// Read the decrypted secure values
	Decrypt bool `protobuf:"varint,2,opt,name=decrypt,proto3" json:"decrypt,omitempty"`
}

func (x *ReadSecureFieldsRequest) Reset() {
	*x = ReadSecureFieldsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReadSecureFieldsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReadSecureFieldsRequest) ProtoMessage() {}

func (x *ReadSecureFieldsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReadSecureFieldsRequest.ProtoReflect.Descriptor instead.
func (*ReadSecureFieldsRequest) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{22}
}

func (x *ReadSecureFieldsRequest) GetKey() *ResourceKey {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *ReadSecureFieldsRequest) GetDecrypt() bool {
	if x != nil {
		return x.Decrypt
	}
	return false
...
type SecureFieldsResponse struct {
	...
	// Error details
	Error *ErrorResult `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	// The results with GUIDs for each value
	Fields map[string]*SecureValue `protobuf:"bytes,2,rep,name=fields,proto3" json:"fields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *SecureFieldsResponse) Reset() {
	*x = SecureFieldsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SecureFieldsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecureFieldsResponse) ProtoMessage() {}

func (x *SecureFieldsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecureFieldsResponse.ProtoReflect.Descriptor instead.
func (*SecureFieldsResponse) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{23}
}

func (x *SecureFieldsResponse) GetError() *ErrorResult {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *SecureFieldsResponse) GetFields() map[string]*SecureValue {
	if x != nil {
		return x.Fields
	}
	return nil
...
var file_resource_proto_rawDesc = []byte{
	...
	0x4b, 0x10, 0x04, 0x12, 0x09, 0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x05, 0x22, 0x4d,
	0x0a, 0x0b, 0x53, 0x65, 0x63, 0x75, 0x72, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x12, 0x0a,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x65, 0x66, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x72, 0x65, 0x66, 0x69, 0x64, 0x22, 0xdd, 0x01,
	0x0a, 0x18, 0x57, 0x72, 0x69, 0x74, 0x65, 0x53, 0x65, 0x63, 0x75, 0x72, 0x65, 0x46, 0x69, 0x65,
	0x6c, 0x64, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x03, 0x6b, 0x65,
	...
	0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x57,
	0x72, 0x69, 0x74, 0x65, 0x53, 0x65, 0x63, 0x75, 0x72, 0x65, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x1a, 0x50, 0x0a, 0x0b, 0x46,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x53, 0x65, 0x63, 0x75, 0x72, 0x65, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x5c, 0x0a,
	0x17, 0x52, 0x65, 0x61, 0x64, 0x53, 0x65, 0x63, 0x75, 0x72, 0x65, 0x46, 0x69, 0x65, 0x6c, 0x64,
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18,
	...
	0x28, 0x08, 0x52, 0x07, 0x64, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x22, 0xd9, 0x01, 0x0a, 0x14,
	0x53, 0x65, 0x63, 0x75, 0x72, 0x65, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70,
	...
	0x72, 0x12, 0x42, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x2a, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x53, 0x65, 0x63,
	...
	0x69, 0x65, 0x6c, 0x64, 0x73, 0x1a, 0x50, 0x0a, 0x0b, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x45,
	...
	0x2e, 0x53, 0x65, 0x63, 0x75, 0x72, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x9a, 0x01, 0x0a, 0x0e, 0x48, 0x69, 0x73, 0x74,
	...
	,
...
var file_resource_proto_goTypes = []any{
	...
	(*WriteSecureFieldsRequest)(nil),       // 24: resource.WriteSecureFieldsRequest
	(*ReadSecureFieldsRequest)(nil),        // 25: resource.ReadSecureFieldsRequest
	(*SecureFieldsResponse)(nil),           // 26: resource.SecureFieldsResponse
	...
	nil,                                    // 35: resource.WriteSecureFieldsRequest.FieldsEntry
	nil,                                    // 36: resource.SecureFieldsResponse.FieldsEntry
}
var file_resource_proto_depIdxs = []int32{
	...
	3,  // 21: resource.WriteSecureFieldsRequest.key:type_name -> resource.ResourceKey
	35, // 22: resource.WriteSecureFieldsRequest.fields:type_name -> resource.WriteSecureFieldsRequest.FieldsEntry
	3,  // 23: resource.ReadSecureFieldsRequest.key:type_name -> resource.ResourceKey
	6,  // 24: resource.SecureFieldsResponse.error:type_name -> resource.ErrorResult
	36, // 25: resource.SecureFieldsResponse.fields:type_name -> resource.SecureFieldsResponse.FieldsEntry
	3,  // 26: resource.HistoryRequest.key:type_name -> resource.ResourceKey
	5,  // 27: resource.HistoryResponse.items:type_name -> resource.ResourceMeta
	6,  // 28: resource.HistoryResponse.error:type_name -> resource.ErrorResult
	3,  // 29: resource.OriginRequest.key:type_name -> resource.ResourceKey
	3,  // 30: resource.ResourceOriginInfo.key:type_name -> resource.ResourceKey
	30, // 31: resource.OriginResponse.items:type_name -> resource.ResourceOriginInfo
	6,  // 32: resource.OriginResponse.error:type_name -> resource.ErrorResult
	2,  // 33: resource.HealthCheckResponse.status:type_name -> resource.HealthCheckResponse.ServingStatus
	23, // 34: resource.WriteSecureFieldsRequest.FieldsEntry.value:type_name -> resource.SecureValue
	23, // 35: resource.SecureFieldsResponse.FieldsEntry.value:type_name -> resource.SecureValue
	15, // 36: resource.ResourceStore.Read:input_type -> resource.ReadRequest
	9,  // 37: resource.ResourceStore.Create:input_type -> resource.CreateRequest
	11, // 38: resource.ResourceStore.Update:input_type -> resource.UpdateRequest
	13, // 39: resource.ResourceStore.Delete:input_type -> resource.DeleteRequest
	19, // 40: resource.ResourceStore.List:input_type -> resource.ListRequest
	21, // 41: resource.ResourceStore.Watch:input_type -> resource.WatchRequest
	24, // 42: resource.SecureFields.WriteSecureFields:input_type -> resource.WriteSecureFieldsRequest
	25, // 43: resource.SecureFields.ReadSecureFields:input_type -> resource.ReadSecureFieldsRequest
	27, // 44: resource.ResourceIndex.History:input_type -> resource.HistoryRequest
	29, // 45: resource.ResourceIndex.Origin:input_type -> resource.OriginRequest
	32, // 46: resource.Diagnostics.IsHealthy:input_type -> resource.HealthCheckRequest
	16, // 47: resource.ResourceStore.Read:output_type -> resource.ReadResponse
	10, // 48: resource.ResourceStore.Create:output_type -> resource.CreateResponse
	12, // 49: resource.ResourceStore.Update:output_type -> resource.UpdateResponse
	14, // 50: resource.ResourceStore.Delete:output_type -> resource.DeleteResponse
	20, // 51: resource.ResourceStore.List:output_type -> resource.ListResponse
	22, // 52: resource.ResourceStore.Watch:output_type -> resource.WatchEvent
	26, // 53: resource.SecureFields.WriteSecureFields:output_type -> resource.SecureFieldsResponse
	26, // 54: resource.SecureFields.ReadSecureFields:output_type -> resource.SecureFieldsResponse
	28, // 55: resource.ResourceIndex.History:output_type -> resource.HistoryResponse
	31, // 56: resource.ResourceIndex.Origin:output_type -> resource.OriginResponse
	33, // 57: resource.Diagnostics.IsHealthy:output_type -> resource.HealthCheckResponse
...
func file_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_resource_proto_msgTypes[21].Exporter = func(v any, i int) any {
			switch v := v.(*WriteSecureFieldsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_resource_proto_msgTypes[22].Exporter = func(v any, i int) any {
			switch v := v.(*ReadSecureFieldsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_resource_proto_msgTypes[23].Exporter = func(v any, i int) any {
			switch v := v.(*SecureFieldsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
